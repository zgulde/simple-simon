...
$(document).ready(function(){
    ...
    var musicalNotes = {
        "C 2": new Audio('../public/media/C2.wav'),
        "C#2": new Audio('../public/media/CS2.wav'),
        "D 2": new Audio('../public/media/D2.wav'),
        "D#2": new Audio('../public/media/DS2.wav'),
        "E 2": new Audio('../public/media/E2.wav'),
        "F 2": new Audio('../public/media/F2.wav'),
        "F#2": new Audio('../public/media/FS2.wav'),
        "G 2": new Audio('../public/media/G2.wav'),
        "G#2": new Audio('../public/media/GS2.wav'),
        "A 2": new Audio('../public/media/A2.wav'),
        "A#2": new Audio('../public/media/AS2.wav'),
        "B 2": new Audio('../public/media/B2.wav'),
        "C 3": new Audio('../public/media/C3.wav'),
        "C#3": new Audio('../public/media/CS3.wav'),
        "D 3": new Audio('../public/media/D3.wav'),
        "D#3": new Audio('../public/media/DS3.wav'),
        "E 3": new Audio('../public/media/E3.wav'),
        "F 3": new Audio('../public/media/F3.wav'),
        "F#3": new Audio('../public/media/FS3.wav'),
        "G 3": new Audio('../public/media/G3.wav'),
        "G#3": new Audio('../public/media/GS3.wav'),
        "A 3": new Audio('../public/media/A3.wav'),
        "A#3": new Audio('../public/media/AS3.wav'),
        "B 3": new Audio('../public/media/B3.wav'),
        "C 4": new Audio('../public/media/C4.wav'),
        "C#4": new Audio('../public/media/CS4.wav'),
        "D 4": new Audio('../public/media/D4.wav'),
        "D#4": new Audio('../public/media/DS4.wav'),
        "E 4": new Audio('../public/media/E4.wav'),
        "F 4": new Audio('../public/media/F4.wav'),
        "F#4": new Audio('../public/media/FS4.wav'),
        "G 4": new Audio('../public/media/G4.wav'),
        "G#4": new Audio('../public/media/GS4.wav'),
        "A 4": new Audio('../public/media/A4.wav'),
        "A#4": new Audio('../public/media/AS4.wav'),
        "B 4": new Audio('../public/media/B4.wav'),
        "C 5": new Audio('../public/media/C5.wav')
    }
